...
-include twd/custom/common/CustConfig.mk
-include twd/custom/$(TWD_PROJECT)/$(TWD_CUST_NAME)/CustConfig.mk
PRODUCT_PROPERTY_OVERRIDES := $(TWD_PRODUCT_PROPERTY_OVERRIDES) $(PRODUCT_PROPERTY_OVERRIDES)
PRODUCT_PACKAGES += $(TWD_PRODUCT_PACKAGES)
